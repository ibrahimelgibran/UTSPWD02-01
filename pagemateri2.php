              ...
              <div class="table-wrapper">
                <div class="table-title">
                  <div class="row">
                    ...
                    <div class="col-sm-6 p-0 d-flex justify-content-lg-end justify-content-center">
                      <a href="home.php"><button class="btn btn-success btn-create">Kembali ke home</button></a>
                    </div>
                  </div>
                </div>
                <table class="table table-striped table-hover">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>3</td>
                      <td>2T 2P</td>
                      <td><a href="https://assignment.amikom.ac.id/20231/20231019/dc1f779d-376e-ee11-8366-a76220400cd7_DT170_20231019112625.docx">Array.docx</a< /td>
                      <td>
                ...
                <div class="clearfix">
                  ...
                  <ul class="pagination">
                    ...
                    <li class="page-item "><a href="home.php" class="page-link">1</a></li>
                ...
                <div class="modal-content">
                  <form>
                    <div class="modal-header">
                      <h4 class="modal-title">Buat RPS</h4>
            ...
            <div id="editEmployeeModal" class="modal fade">
              <div class="modal-dialog">
                <div class="modal-content">
                  <form>
                    <div class="modal-header">
                      <h4 class="modal-title">Edit RPS</h4>
                      <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    </div>
                    <div class="modal-body">
                      <div class="form-group">
