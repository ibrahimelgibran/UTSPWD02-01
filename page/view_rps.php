                                ...
                                <div class="container">
                                    <div class="row content">
                                        ...
                                        <table class="table text-center">
                                            <tr>
                                                <td colspan="4" style="border-bottom: 1px #bdc3c7 solid;">
                                                    <h1>RENCANA PEMBELAJARAN SEMESTER (RPS)</h1>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="4" style="padding: 1px;" class="no_doc_rps">
                                                    <h6 style="margin:0; padding: 0;">FM-PJM-011/Rev.00/23 Oktober 2023</h6>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="4"><img src="../img/logo.png" width="300"></td>
                                            </tr>
                                            <tr>
                                                <td colspan="4">
                                                    <h3 style="margin:0; padding: 0;">MATA KULIAH : PERANCANGAN WEB 2 (DT01)</h3>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="4">
