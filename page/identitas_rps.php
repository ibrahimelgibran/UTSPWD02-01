        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav nav-tabs" style="font-size: 13.5px;">
              ...
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="identitas_rps.php">Identitas RPS</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#">Gambaran Umum</a>
              </li>
              <li class="nav-item">
          ...
          <div class="container-fluid">
            ...
            <div class="tab-content">
              ...
              <form action="/action_page.php">
                ...
                <button type="" class="btn btn-info"><a href="./view.php">View</a></button>
              </form>
